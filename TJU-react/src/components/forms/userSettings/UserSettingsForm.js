            ...
            {(requestAccountDeletion, { loading, data }) => {
              ...
              return (
                <>
                  <Message warning>
                    <FormattedMessage
                      defaultMessage="All your data will be removed from the TJUer servers. We will not be able to recover any of your data, should you find that you would still have needed it."
                      id="form.userSettings.string.accountDeletionWarning"
                    />
                  </Message>
                  <Message info>
                    <FormattedMessage
                      defaultMessage="To request deletion of your TJUer account, please click the button below. You will be sent an email that will allow you to confirm your account deletion."
